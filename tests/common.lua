...
function create_insert(table_id)
   ...
   print("Creating table 'mgtest" .. i .. "'...")
   if (db_driver == "mysql") then
      query = [[
CREATE TABLE mgtest]] .. i .. [[ (
id INTEGER UNSIGNED NOT NULL ]] ..
((oltp_auto_inc and "AUTO_INCREMENT") or "") .. [[,
k INTEGER UNSIGNED DEFAULT '0' NOT NULL,
c CHAR(255) DEFAULT '' NOT NULL,
pad VARCHAR(300) DEFAULT '' NOT NULL,
]] .. index_name .. [[ (id)
...
pad CHAR(60) DEFAULT '' NOT NULL,
   ...
   db_query("CREATE INDEX k_" .. i .. " on mgtest" .. i .. "(k)")

   print("Inserting " .. oltp_table_size .. " records into 'mgtest" .. i .. "'")

   if (oltp_auto_inc) then
      db_bulk_insert_init("INSERT INTO mgtest" .. i .. "(k, c, pad) VALUES")
   else
      db_bulk_insert_init("INSERT INTO mgtest" .. i .. "(id, k, c, pad) VALUES")
   end
...
function cleanup()
   ...
   for i = 1,oltp_tables_count do
   print("Dropping table 'mgtest" .. i .. "'...")
   db_query("DROP TABLE mgtest".. i )
   end
end
